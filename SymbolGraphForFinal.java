 ...
 *  @author Kevin Wayne
 */
public class SymbolGraphForFinal {
    private ST<String, Integer> st;  // string -> index
    private String[] keys;           // index  -> string
    private Graph graph;             // the underlying graph
    private int movies;              // number of movies
    private int actors;              // number of actors
     ...
     */
    public SymbolGraphForFinal(String filename, String delimiter) {
    ...
    public static void main(String[] args) {
        ...
        SymbolGraphForFinal sg = new SymbolGraphForFinal(filename, delimiter);
        Graph graph = sg.graph();

        CCForFinal cc = new CCForFinal(graph);
        StdOut.println(cc.count());

        int[] test = {118774, 21, 29, 46, 27, 23, 23, 67, 19, 13, 12, 12, 11, 2, 44, 26, 27, 14, 18, 18, 11, 6, 9, 20, 16, 8, 7, 29, 10, 11, 25, 17, 34};
